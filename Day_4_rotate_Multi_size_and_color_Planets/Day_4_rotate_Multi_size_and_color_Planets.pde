...
void drawPlanet(float angle, float distance, float size, color c) //must have a _cx and a _cy for this method of function making to work.
{
  pushMatrix();
